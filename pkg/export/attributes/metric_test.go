...
func TestPrometheusNames(t *testing.T) {
	tests := []struct {
		...
		{GenAIClientInputTokenUsage, "gen_ai_client_input_token_usage"},
		{GenAIClientOutputTokenUsage, "gen_ai_client_output_token_usage"},
		{GenAIClientOperationDuration, "gen_ai_client_operation_duration_seconds"},
		{GenAIExecuteToolDuration, "gen_ai_execute_tool_duration_seconds"},
